...
#### LISA
Для покупки первого жилья рекомендуется испольвать [LISA](https://www.gov.uk/lifetime-isa) накопительный счет который позволяет получать 25% от государства (мужи и жена могут октрыть счет с макс пополненем 4000 + 4000 и получить 1000 + 1000 от государство, не является public funds)
...
Делая оффер, для поднятия шансов желательно отразить следующие моменты:
- first-time buyer
- chain-free
- хороший депозит
...
Верные варианты поиска новой мебели и техники с доставкой это ikea и argos.
